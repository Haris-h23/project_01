Feature: Activity management
  ...
  Scenario: Create a new activity
    Given I create an activity named "Design" with 50 hours, start week 12, and end week 16
  ...
  Scenario: Edit activity properties
    Given I create an activity named "Temp" with 10 hours, start week 1, and end week 2
  ...
  Scenario: Update status
    Given I create an activity named "QA" with 30 hours, start week 20, and end week 22
  ...
  Scenario: assigning a user to an activity
    Given I create an activity named "Development" with 40 hours, start week 15, and end week 20
